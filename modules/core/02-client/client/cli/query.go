...
func GetCmdQueryCounterpartyInfo() *cobra.Command { _ = "STUB: not implemented"; return nil }

// GetCmdQueryClientCreator defines the command to query the creator of a client
func GetCmdQueryClientCreator() *cobra.Command { _ = "STUB: not implemented"; return nil }

// GetCmdQueryClientConfig defines the command to query a client's configuration
func GetCmdQueryClientConfig() *cobra.Command { _ = "STUB: not implemented"; return nil }
...
func GetCmdClientParams() *cobra.Command { _ = "STUB: not implemented"; return nil }
